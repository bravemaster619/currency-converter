...
public class DefaultExchangeRateProvider implements ExchangeRateProvider {
    ...
    public double getExchangeRate(String cur1, String cur2) throws CurrencyNotFoundException{
        try {
            double rate1 = ExRate.valueOf(cur1.toUpperCase()).rateInGBP;
            double rate2 = ExRate.valueOf(cur2.toUpperCase()).rateInGBP;
            return rate2/rate1;
        } catch(IllegalArgumentException ex) {
            throw new CurrencyNotFoundException(cur1 + " or " + cur2 + " is unsupported.");
        }
    }
